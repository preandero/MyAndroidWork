...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        Log.d("myapp","onPreparedOptionsMenu - 옵션메뉴가 화면에 보여질때 마다 호출됨");
        ...
        return super.onPrepareOptionsMenu(menu); // false 리턴하면 메뉴는 보여지지 않는다.
    }
    ...
    public void showInfo(MenuItem item){
        ...
        int groupId = item.getGroupId();  // 옵션 메뉴 아이템의 그릅 id 값 (정수)
