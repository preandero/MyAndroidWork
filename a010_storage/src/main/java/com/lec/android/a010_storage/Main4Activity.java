...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if("".equals(name)){
                    tvResult.setText("DELETE 실패 - 삭제 할 이름을 입력하세요.");
                    return;
                }
    ...
    void insert(String name, int age, String address){
        ...
        // 리턴값은 auto-generated key, 실패하면 -1 리턴
       long result = db.insert(tableName,null,values);

       Log.d("myapp", DatabaseUtils.queryNumEntries(db, tableName)+ "번째 row INSERT 성공");
       tvResult.setText(DatabaseUtils.queryNumEntries(db, tableName)+ "개 row INSERT 성공");
       select();
