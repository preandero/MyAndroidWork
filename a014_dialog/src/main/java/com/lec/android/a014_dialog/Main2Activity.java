        ...
        switch (id){
                ...
                builder1.setTitle("다이얼로그 제목임")
                        ...
                        .setPositiveButton("긍정", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(Main2Activity.this, "긍정", Toast.LENGTH_LONG).show();
                            }
                        })
                .setNegativeButton("부정", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(Main2Activity.this, "부정", Toast.LENGTH_LONG).show();
                    }
                }).setNeutralButton("중립", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(Main2Activity.this,"중립",Toast.LENGTH_LONG).show();
                    }
                });
            ...
            case DIALOG_LIST:
                ...
                final String str[] = {"사과", "딸기", "수박", "배" };
                    builder2.setTitle("리스트 형식 다이얼로그 제목")
                            ...
                            .setItems(str, // 리스트 목록에 사용할 배
                                    new DialogInterface.OnClickListener() {
                                // 리스트 아이템이 선택되었을때 호출되는 콜백
                                // which : 몇번째 선택되었는지 에 대한 정보
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Toast.makeText(Main2Activity.this,"선택은: " + str[which] ,Toast.LENGTH_LONG).show();
                                }
                            });
                    builder2.show();
                    return builder2;
            case DIALOG_RADIO:
                ...
                builder3.setTitle("색을 고르세요")
                        .setPositiveButton("선택완료", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(Main2Activity.this, str2[choice] + "을 선택",Toast.LENGTH_LONG).show();
                            }
                        })
                        .setNegativeButton("취소", null)
                        .setSingleChoiceItems(str2,
                                -1, // 기본설정값
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
            ...
            case DIALOG_MULTICHOICE:
                ...
                builder4.setTitle("MultiChoice 다이얼로그 제목")
                        ...
                        .setMultiChoiceItems(data, checked,
